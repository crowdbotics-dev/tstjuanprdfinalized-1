"""
Django settings for tstjuanprdfinalized_1 project.
...
ROOT_URLCONF = 'tstjuanprdfinalized_1.urls'
...
WSGI_APPLICATION = 'tstjuanprdfinalized_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tstjuanprdfinalized_1 API",
    "DESCRIPTION": "API documentation for tstjuanprdfinalized_1 App",
    "VERSION": "v1",
}
